...
const LoginModal = () => {
  ...
  // Define toggle function to switch to registration modal
  const onToggle = useCallback(() => {
    loginModal.onClose();
    registerModal.onOpen();
  }, [loginModal, registerModal]);

  // Define content for modal body
  const bodyContent = (
  ...
  // Define content for modal footer
  const footerContent = (
    <div className="flex flex-col gap-4 mt-3">
      ...
      <div className="text-neutral-500 text-center mt-4 font-light">
        <p>
          First time using EZHomesteading?
          <span
            onClick={onToggle}
  ...
  // Render the modal component with defined content and handlers
  return (
    <Modal
      disabled={isLoading}

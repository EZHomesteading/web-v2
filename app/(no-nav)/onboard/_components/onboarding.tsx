...
import StepOne from "@/app/(no-nav)/onboard/_components/_steps/step1";
import StepTwo from "@/app/(no-nav)/onboard/_components/_steps/step2";
import StepThree from "@/app/(no-nav)/onboard/_components/_steps/step3";
import StepFour from "@/app/(no-nav)/onboard/_components/_steps/step4";
import { StepFive } from "@/app/(no-nav)/onboard/_components/_steps/step5";
import StepSix from "@/app/(no-nav)/onboard/_components/_steps/step6";
import StepSeven from "@/app/(no-nav)/onboard/_components/_steps/step7";
import StepEight from "@/app/(no-nav)/onboard/_components/_steps/step8";

    ...
    >
      ...
      >
        ...
        <ul className="list-disc list-inside mb-4">
            <li>Buyers automatically message you with their preferred pickup time based on your listed hours.</li>
            <li>You can confirm, reschedule, or deny the order.</li>
            <li>Confirmation means the order will be ready at the specified time and location.</li>
            <li>Rescheduling allows the buyer to accept, deny, or propose a new time.</li>
            <li>Prices and pickup locations are <em>non-negotiable</em>. Pickup times are limited to your business hours.</li>
        </ul>
        <Button
